(function() {
    ...
    series: [
      {
        ...
        type: 'bar',
        data: [
          { value: -120.8, itemStyle: { color: down } },
          { value: -104, itemStyle: { color: down } },
          { value: -71, itemStyle: { color: down } },
          { value: 172, itemStyle: { color: up } }
        ],
        barWidth: '40%',
        label: {
          show: true,
      ...
      },
      {
        ...
        yAxisIndex: 1,
        data: [
          { value: 1846, name: '上涨', itemStyle: { color: up } },
          { value: 3570, name: '下跌', itemStyle: { color: down } },
          { value: 133, name: '平盘', itemStyle: { color: muted } },
  ...
  // --- Chart 2: Global Index Comparison ---
  ...
  // 近5日涨跌幅数据
  var day1 = [-0.7878, -1.028, -0.7113, -0.928, -0.2951, -1.003, -1.316];
  var day2 = [0.5592, 0.4523, 0.4603, -0.07312, -1.377, -1.612, -2.392];
  var day3 = [1.176, 1.397, 1.058, -0.3868, 0.1016, 0.3101, 0.009];
